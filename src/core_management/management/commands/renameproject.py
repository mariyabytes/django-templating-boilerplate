...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser, *args, **kwargs):
        parser.add_argument(
            "oldProjName", type=str, help="The name of the old django project."
        )
        parser.add_argument(
            "newProjName", type=str, help="The name of the new django project."
        )
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Project has been renamed to {newProjName}")
        )
